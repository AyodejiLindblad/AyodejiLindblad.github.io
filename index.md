...
I'm a fourth-year PhD student of [Tom Mrowka](https://math.mit.edu/~mrowka/) at [MIT](https://math.mit.edu/directory/profile.html?pid=2594) with interests in low-dimensional topology (especially diffeomorphisms and gauge theory in dimension 4) and discrete geometry. My research has been supported by the [MIT Dean of Science Fellowship](https://science.mit.edu/about/awards/deans-fellowship-program/). Previously, I graduated from MIT with a BS in mathematics. You can reach me at [my_first_name@mit.edu](mailto:my_first_name@mit.edu) and can find my [CV at this link](Ayodeji-Lindblad-CV.pdf).
...
* [Boundary Dehn twists are often commutators](research/Boundary-Dehn-twists-are-often-commutators.pdf). *[arXiv:2604.13194](https://arxiv.org/abs/2604.13194), submitted for publication*, 2026.  
    Concretely realizes the boundary Dehn twist as a commutator in the smooth mapping class group rel boundary of all complete intersections, all connected sums thereof, and further broad classes of manifolds, notably showing that boundary Dehn twists known to be nontrivial in the smooth mapping class group rel boundary by work of [Baraglia-Konno](https://londmathsoc.onlinelibrary.wiley.com/doi/full/10.1112/topo.12229) ([see also](https://projecteuclid.org/journals/duke-mathematical-journal/volume-175/issue-4/Irreducible-4-manifolds-can-admit-exotic-diffeomorphisms/10.1215/00127094-2025-0040.short)), [Kronheimer-Mrowka](https://archive.intlpress.com/site/pub/files/_fulltext/journals/mrl/2020/0027/0006/MRL-2020-0027-0006-a008.pdf), [Jianfeng Lin](https://msp.org/gt/2023/27-5/gt-v27-n5-p07-s.pdf), and [Tilton](https://arxiv.org/abs/2511.16804) become trivial after abelianization.
...
* [Boundary Dehn twists are often commutators (lightning)](talks/Boundary-Dehn-twists-are-often-commutators-(lightning).pdf). *[OIST TSVP Autumn School on Gauge Theory, Topology, and Physics](https://sites.google.com/view/new-frontiers-in-gauge-theory/autumn-school?authuser=0)*, 2026.  
...
* [Boundary Dehn twists are often commutators](talks/Boundary-Dehn-twists-are-often-commutators-(general-audience).pdf). *[AMS New England Graduate Student Conference](https://sites.google.com/brown.edu/amsgradconference/home)*, 2026.  
    I gave an overview of [my work of the same name](https://arxiv.org/pdf/2604.13194) which proves that boundary Dehn twists can often be concretely represented as commutators in the smooth mapping class group rel boundary, notably showing that they often become trivial after abelianization.
...
* 18.03 recitation instructor. *MIT*, 2026.  
    I am leading a recitation for 18.03 (differential equations) at MIT during the Fall 2026 semester.
...
* [The MIT Geometry & Topology Seminar](/seminars/MIT-G&T-FA26/). *MIT*, 2026-2027.  
Joint with [Joye Chen](https://math.mit.edu/directory/profile.html?pid=2584).
    We will co-organize the MIT Geometry & Topology Seminar for the 2026-2027 academic year.
...
<div id="figures" class="toc-jump"></div>
  ...
  <figure style="display: inline-block; margin: 0; width: min(var(--img-width), 100%);">
    ...
    >
      <a href="talks/Skein-lasagna-modules-and-handle-attachments.pdf"
         style="display: block; width: 100%; overflow-wrap: anywhere; word-break: break-word;">
        Adding a pair of sheets to the surface of a lasagna filling, an operation important in computing the skein lasagna modules of 2-handlebodies.
      </a>
    </figcaption>
  </figure>
</div>
...
<div style="flex: 1; text-align: center; --img-width: 525px;">
  <figure style="display: inline-block; margin: 0; width: min(var(--img-width), 100%);">
    <img
    ...
    <figcaption
      ...
      "
    >
      <a href="https://arxiv.org/pdf/2604.13194"
         style="display: block; width: 100%; overflow-wrap: anywhere; word-break: break-word;">
...
This website (and, I think, its sub-pages) has been loaded <span id="site-total-number">—</span> total times since its creation at the end of 2025.
